<x-base-layout>
    <div class="mt-6">
        ...
        <div class="mx-auto text-center mt-2">
            <p class="inline-block text-center text-xl bg-blue-500 font-bold rounded-full text-white w-8 h-8 pt-1"
                id="c1">1</p>
            <div class="inline-block mx-3 bg-black w-10 h-1 mb-1 bg-opacity-50" id="l1"></div>
            <p class="inline-block text-center text-xl bg-white  font-bold rounded-full text-blue-500  w-8 h-8 pt-1"
                id="c2">✓</p>
        </div>
        <style>
            .text-red-600 {
    ...
    <div style="display: grid;grid-template-columns: auto auto auto auto;">
        ...
        <div class="text-center text-xl my-4 mb-2 hidden" id="nearCampaignsUserLocation">
            <p>Campaigns Near your location: </p>
            <select class="text-md text-black" onchange="selectCampaignOption()" style="width: 20rem;">
                <option value="-1">Select a campaign</option>
            </select>
        </div>
        ...
        <div class="text-center text-xl my-4 mb-2 hidden" id="nearCampaignsUserMarker">
            <p>Campaigns Near your marker location: </p>
            <select class="text-md text-black" onchange="selectCampaignOption()" style="width: 20rem;">
                <option value="-1">Select a campaign</option>
            </select>
        </div>
