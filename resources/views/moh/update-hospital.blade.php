            ...
            <form method="POST">
                ...
                <div class="form-group row">
                    <div class="col-12 col-md-6">
                        <label>Name</label>
                        <input value="{{ $hospital->name }}" type="text" class="form-control" name="name"
                            required>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <br>
                        <input value="{{ $hospital->is_isolation }}" class="form-check-input" type="checkbox"
                            name="is_isolation" checked>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-12 col-md-6">
                        ...
                        <input value="{{ $hospital->capacity }}" class="form-control" type="number" min="1"
