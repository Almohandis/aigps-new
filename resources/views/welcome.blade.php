        ...
        <div class="slideshow-container__slides">
            <div class="slideshow-container__text">
                <h1 class="article-head"><b> Pandemics: Risks, Impacts, and Mitigation </b></h1>
                    ...
                    <iframe class="video" src="https://www.youtube.com/embed/JU6KH8Z4QG8?autoplay=1&mute=1"></iframe>
                    <div class= "article">
                        <h2  class="abstract"><b>Abstract</b></h2>
                        ...
                        The international community has made progress toward preparing for and mitigating the impacts of pandemics. The 2003 severe acute respiratory syndrome (SARS) pandemic and growing concerns about the threat posed by avian influenza led many countries to devise pandemic plans (U.S. Department of Health and Human Services 2005). Delayed reporting of early SARS cases also led the World Health Assembly to update the International Health Regulations (IHR) to compel all World Health Organization member states to meet specific standards for detecting, reporting on, and responding to outbreaks (WHO 2005). <br><a style="color:red;">To read the full article visit:</a> <a style="color:#6868cc;" href="https://pubmed.ncbi.nlm.nih.gov/30212163/" target="_blank">https://pubmed.ncbi.nlm.nih.gov/30212163/</a></p>
                    </div>
            </div>
        </div>

        <div class="slideshow-container__slides">
            <div class="slideshow-container__text"><h1 class="article-head"><b> How the Pandemic Is Changing Health Care </b></h1>
                <img class="awareness-img" src="health.jpg">
                <iframe class="video" src="https://www.youtube.com/embed/FVIGhz3uwuQ?autoplay=1&mute=1"></iframe>
                <div class= "article">
                    <h2  class="abstract"><b>Abstract</b></h2>
                    <p class="article-body">The COVID-19 pandemic has turned the health care system upside down and challenged consumers’ sense of well-being. In many ways, consumers are taking charge of their health more than ever before. They are learning about their health risks, communicating with their doctors in new and different ways, and changing their attitudes about data privacy. Each of these factors has a significant influence on how patients are interacting with the health system. Going forward, how will these events and factors change their behavior? Are we more or less likely to see empowered health care consumers? The Deloitte “2020 Survey of U.S. Health Care Consumers” provides insights into current U.S. consumer behaviors and attitudes. Since 2008, Deloitte has been conducting this biennial survey to explore and collect longitudinal data on the subject. This year’s survey was fielded just before the pandemic started; additional research, the “Health Care Consumer Response to COVID-19 Survey,” collected insights in April and early May.

Findings show that:

<b>Many consumers are demonstrating agency and engagement</b>. Patients increasingly are willing to tell their doctors when they disagree with them and are using tools to get information on health issues and costs. Consumers also are tracking their health conditions, using that data to make decisions, and accessing and using their medical record data.<br><a style="color:red;">To read the full article visit:</a> <a style="color:#6868cc;" href="https://deloitte.wsj.com/articles/how-the-pandemic-is-changing-health-care-01600369326" target="_blank">https://deloitte.wsj.com/articles/how-the-pandemic-is-changing-health-care-01600369326</a></p>
                </div>
            </div>
        </div>
